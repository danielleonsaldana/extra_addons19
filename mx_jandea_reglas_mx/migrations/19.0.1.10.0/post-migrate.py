# -*- coding: utf-8 -*-
"""Sincroniza el Finiquito con la definición 19.0.1.10.0.

Corrige en las reglas ya creadas (sin desinstalar):
  * El salario diario CAPTURADO en FNQT_SD_IMSS ahora MANDA por encima del
    sueldo del contrato. En estos contratos el "wage" suele venir mal (mitad)
    o en 0; antes se ignoraba la captura si el contrato traia sueldo, y por eso
    aguinaldo/vacaciones/prima salian a la mitad y el ISR quedaba mal.
"""
import logging
